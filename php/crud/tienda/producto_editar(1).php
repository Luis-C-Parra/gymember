...
<head>
    ...
    <title>GyMember | Editar Producto: <?php echo htmlspecialchars($producto['nombre']); ?></title>
...
<body>
    ...
    <!-- cambié la clase a container -->
    <main class="container">
        <!-- cambié la clase a título-->
        <h1 class="titulo">Editar Producto: <?php echo htmlspecialchars($producto['nombre']); ?></h1>
